...
#define flash                         \
    ...
    cout.tie(NULL);
using namespace std;
double average_turnaround_time(ll turnaround[], ll n)
{
    double res = 0;
    for (int i = 0; i < n; i++)
    {
    ...
    res /= n;
    cout << "1-->Average turnaround time is " << res << endl;
}
double average_waiting_time(ll waiting[], ll n)
{
    double res = 0;
    for (int i = 0; i < n; i++)
    {
    ...
    res /= n;
    cout << "2-->Average waiting time is " << res << endl;
}
double average_response_time(ll response[], ll n)
{
    double res = 0;
    for (int i = 0; i < n; i++)
    {
    ...
    res /= n;
    cout << "3-->Average response time is " << res << endl;
}
double overall_throughput(ll timer, ll n)
{
    double res = timer / n;
    cout << "4-->Overall throughput is " << res << endl;
}
int main()
{
    ...
    while (input_file >> number)
    {
        n++;
        input_file >> number;
        arrival_time.push_back(number);
        input_file >> number;
        cpu_burst.push_back(number);
    }
    bool ok = 1;
    input_file.close();
    while (ok)
    {
        cout << "\nChoose the scheduling algorithm on which you have to run the given processes"
             << endl;
        cout << "\n(1) for First come first serve (FCSF)" << endl;
        cout << "(2) for Shortest job first (SJF)" << endl;
        cout << "(3) for Shortest time remainig first (SRTF)" << endl;
